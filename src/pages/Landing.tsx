        ...
        >
          <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Yuvi-bot provides compassionate AI support, mood tracking, journaling, and crisis resources - all designed to help you navigate life's challenges with care and understanding.
            </p>
